...
class _PickColorState extends State<PickColor> {
  ...
  void initState() {
    super.initState();
    pickedColor = jarController.currentJar['bgColor'] != null
        ? Color(jarController.currentJar['bgColor'])
        : Colors.blueGrey;
  }
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  jarController.currentJar['bgGradient'] = null;
                  jarController.currentJar['bgImage'] = null;
                  jarController.currentJar['bgColor'] = pickedColor.value;
