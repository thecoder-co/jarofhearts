...
import 'package:jar_of_hearts/screens/edit_jar/edit_jar_second_page.dart';
import 'package:jar_of_hearts/utils/size.dart';

class EditStartView extends StatefulWidget {
  const EditStartView({Key? key}) : super(key: key);

  @override
  State<EditStartView> createState() => _EditStartViewState();
}

class _EditStartViewState extends State<EditStartView> {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    if ((jarController.currentJar['pages'] as List?)?.isEmpty ??
                        true) {
                    ...
                    Get.to(() => const EditJarSecondPage());
                  },
                  child: Container(
                    decoration: BoxDecoration(
                      gradient: cardBgGradient != null
